...
task freyja_one_sample {
  ...
  echo ${freyja_usher_barcode_version} | tee FREYJA_BARCODES # date barcodes attemped to download
  echo ${freyja_metadata_version} | tee FREYJA_METADATA # date metadata attemped to download
